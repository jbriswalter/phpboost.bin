...
{/if})</code>
	...
	<p><strong>Conflicts with functions:</strong> 
...
{* original    {if $functions[func].function_conflicts != ""
		<strong>Conflicts:</strong> {$functions[func].function_conflicts<br /><br />
    {/if *}
    ...
    <table border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td><strong>{$functions[func].params[params].var}</strong>&nbsp;&nbsp;</td>
